...
def run():
    ...
    save_path = f'saved/fitted_models/simple_synthetic_deltarelupoisson_vmean_em{num_em}_{K}_{L}_{sample_length}_{C}_{alpha}_{seed}_{init_type}_{optim_type}_fitted'
