...
def run():
    ...
    if args.C > 0:
        ...
        save_path = f'saved/synthetic_data/singlefreq_{J_sel}_latent_deltarelu_{K}_{L}_{sample_length}_{C}_{alpha}_{seed}.pkl'
    ...
    Gamma_load_path = f'saved/synthetic_data/simple_latent_deltarelu_{K}_{L}_{sample_length}.pkl'
