...
do
    ...
    do
        ...
        do
            ...
            python fit/fit_simple.py latent=single_freq_log obs=pp_log latent.L=$L latent.seed=$seed obs.mu=$mu obs.seed=$seed model.eigvals_flag=$evalf model.model_init=$init model.scale_init=$scale_init
        done
    done
done
