...
do
    ...
    do
        ...
        # for mu in -1.0
        do
            python ../simulate/simulate_simple_fullrank.py latent=single_freq_log obs=pp_log latent.gamma_seed=$gseed latent.K=$K latent.rank=$K latent.L=$L latent.seed=$seed obs.mu=$mu obs.seed=$seed
        done
    done
done
