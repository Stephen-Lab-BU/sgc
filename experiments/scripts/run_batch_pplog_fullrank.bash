...
do
    ...
    do
        ...
        do
            ...
            python fit/fit_simple_fullrank.py latent=single_freq_log obs=pp_log model=fullrank latent.L=$L latent.seed=$seed obs.mu=$mu obs.seed=$seed model.model_init=$init model.scale_init=$scale_init
        done
    done
done