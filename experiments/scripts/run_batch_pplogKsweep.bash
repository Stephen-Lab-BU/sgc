...
do
    ...
    do
        ...
        do
            python simulate/simulate_simple.py latent=single_freq_log obs=pp_log latent.K=$K latent.L=$L latent.seed=$seed obs.mu=$mu obs.seed=$seed
            python fit/fit_simple.py latent=single_freq_log obs=pp_log latent.L=$L latent.K=$K latent.seed=$seed obs.mu=$mu obs.seed=$seed model.eigvals_flag=$evalf model.model_init=$init
        done
    done
done
