...
do
    ...
    do
        ...
        do
            ...
            python ../fit/fit_model.py latent=single_freq_log obs=pp_log model=lowrank_eigh latent.L=$L latent.seed=$seed obs.mu=$mu obs.seed=$seed model.eigvals_flag=$evalf model.model_init=$init 
        done
    done
done