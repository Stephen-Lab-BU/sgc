...
for seed in 0 1 2 3 4 
do
    python plot/plot_lowrank1_fit.py latent=single_freq_log obs=pp_log model.eigvals_flag=$eigvalflag \
    latent.seed=$seed obs.seed=$seed model.model_init=$init 'plot.Ls=[5,10,25,50,100]' 'plot.thetas=[-2.0,-1.0,0.0,2.0,4.0]'
done