...
def run():
    ...
    load_gamma_path = 'saved/synthetic_data/simple_synthetic_gaussian_3_25_1000_1_-1.0_1.0_0.0_8'
    ...
    save_path = f'saved/fitted_models/simple_synthetic_gaussian_{K}_{L}_{sample_length}_{C}_{mu}_{ov1}_{ov2}_{seed}_fitted'
    ...
    # Gamma_true_inv = np.stack([np.linalg.pinv(Gamma_true[j,:,:]) for j in range(J)])
