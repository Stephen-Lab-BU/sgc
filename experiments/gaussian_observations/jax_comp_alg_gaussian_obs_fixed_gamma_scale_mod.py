...
def run():
    ...
    save_path = f'saved/fitted_models/scale_mod_jax_comp_simple_synthetic_gaussian_em{num_em}_{K}_{L}_{sample_length}_{C}_{mu}_{ov1}_{ov2}_{seed}_fitted_{etype}.pkl'
