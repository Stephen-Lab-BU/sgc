...
def get_plot_dir(cfg, dim, funcname):
    plot_dir = f'data/figs-fit/{cfg.plot.plot_type}/latent-{cfg.latent.latent_type}/eigval-{cfg.model.eigvals_flag}/window-{int(2*cfg.latent.num_freqs)}/K{cfg.latent.K}/obs-{cfg.obs.obs_type}/init-{cfg.model.model_init}/func-{funcname}/dim-{dim}'
    return plot_dir
