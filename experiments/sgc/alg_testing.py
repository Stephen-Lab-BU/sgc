...
from cohlib.utils import pickle_save, pickle_open, get_dcval
...
def run():
    ...
    save_path = f'saved/fitted_models/simple_synthetic_{K}_{L}_{sample_length}_{C}_{mu}_{seed}_fitted'
