...
def run():
    ...
    res_paths = [f'/projectnb/stephenlab/jtauber/cohlib/hydra/gaussian_obs_postfix/batch/outputs/{date}-rankR/{ts_flag}/{ts_flag2}/{gamma_name}/seed-{seed}']
    save_dir_gamma = f'/projectnb/stephenlab/jtauber/cohlib/hydra/gaussian_obs_postfix/figs/batch_rankR/{ts_flag}/{ts_flag2}/{gamma_name}/{seed}'
